...
class CourseDetails extends StatelessWidget {
      ...
      body: SafeArea(
        ...
        child: LayoutBuilder(builder: (context, constraints) {
          ...
          final extraContentPadding =
              max<double>(totalWidth - AppLayout.maximumContentWidthDetail, 0) / 2;
            ...
            children: <Widget>[
              Column(
                children: <Widget>[
                  ...
                  Expanded(child: _scrollableView(extraContentPadding)),
                  _bottomArea(extraContentPadding),
                ],
              ),
              Positioned(
  ...
  Widget _scrollableView(double extraContentPadding) {
      ...
      child: Padding(
        ...
        child: Column(
          children: <Widget>[
            ...
            Padding(
              padding:
                  EdgeInsets.symmetric(horizontal: 16.0 + extraContentPadding),
              child: Column(
                children: [
                  Container(
                    color: Colors.grey,
  ...
  Widget _bottomArea(double extraContentPadding) {
    return Padding(
      padding: EdgeInsets.symmetric(horizontal: extraContentPadding),
      child: Container(
